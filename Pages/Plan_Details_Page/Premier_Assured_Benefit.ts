...
export class PAB {
    ...
    async fillPlanDetails(testcaseID: string) {
        ...
        if(data.Maturity_Benefit === 'Settlement-Installments') {
        ...
        if(data.Death_Benefit === 'Life Plus-Installments') {
        ...
        if ((data.Life_Cover === 'Life Option' && ageInt <= 60) || (data.Life_Cover === 'Life Plus Option' && ageInt <= 50)) {
