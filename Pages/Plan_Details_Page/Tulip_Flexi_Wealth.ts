...
export class TulipCombi2 {
    ...
    async fillPlanDetails(testcaseID: string) {
        ...
        await this.flexiDropdown('Life Cover Option', data.Tulip_Plan1_Life_Cover_Option);
        await dropdown.selectAntDropdown('PlansubOptval.suboption_252', data.Tulip_Plan1_Sub_Option_Cover);
        ...
        if(saAmount < 5000000) {
            if(data.Tulip_Plan1_VMER === 'YES') {
                await this.VMER_Yes.click();
            } //else if(data.Tulip_Plan1_VMER === 'NO') {
