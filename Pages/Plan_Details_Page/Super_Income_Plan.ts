...
export class SIP {
    ...
    async fillPlanDetails(testcaseID: string) {
        ...
        await dropdown.selectPlanPageDropdown('Maturity Benefit', data.Maturity_Benefit);
        await dropdown.selectPlanPageDropdown('Death Benefit', data.Death_Benefit);
        ...
        if (ageInt >= 25 && ageInt <= 50) {
            let PT: string = (75-ageInt).toString();
